...
export const selectUserListErrorMessage = (state: AppRootState) =>
  state.user.users.userListErrorMessage;

export const selectCurrentUser = (state: AppRootState) => state.user.user.currentUser;
export const selectCurrentUserIsLoading = (state: AppRootState) =>
  state.user.user.currentUserIsLoading;
export const selectCurrentUserErrorMessage = (state: AppRootState) =>
  state.user.user.currentUserErrorMessage;
